        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-heading font-bold text-xl text-white">BookNest</span>
            </div>
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a href="#" className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Instagram">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Email">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link to="/" className="text-brand-300 hover:text-white transition-colors">Home</Link></li>
              <li><Link to="/categories" className="text-brand-300 hover:text-white transition-colors">Categories</Link></li>
              <li><Link to="/learn-language" className="text-brand-300 hover:text-white transition-colors">Improve Language</Link></li>
              <li><Link to="/about" className="text-brand-300 hover:text-white transition-colors">About</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><a href="#" className="text-brand-300 hover:text-white transition-colors">Help Center</a></li>
              ...
              <li><a href="#" className="text-brand-300 hover:text-white transition-colors">Contact Us</a></li>
            </ul>
          </div>
