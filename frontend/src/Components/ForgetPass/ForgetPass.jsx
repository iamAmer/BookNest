  ...
  return <>
    <div className='bg-[#F8F6F3]'>
      ...
      <div className='bg-[#FFFFFF] header-font text-[#4A4A4A] rounded-3xl p-10 shadow-[0_4px_6px_-4px_rgba(0,0,0,0.1),0_10px_15px_-3px_rgba(0,0,0,0.1)]'>
        <button className='relative -left-5'><i class="fa-solid fa-arrow-left "></i> Back to Login</button>
        <div>
        ...
        <form className="max-w-sm mx-auto mt-4" onSubmit={formik.handleSubmit}>
          ...
          <button type="submit" className="text-[#FFFFFF] bg-[#D4A574] w-full box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">Send Reset Link</button>
        </form>
      </div>
      </div>
      <div className=''>
