      ...
      <div className="min-h-screen bg-[#EDE0CF] flex items-center justify-center p-8">
        ...
        <div className="anim-card flex rounded-[28px] overflow-hidden shadow-2xl w-full max-w-3xl min-h-[540px]">
          ...
          <div className="bg-[#DBBE9E] w-[50%] p-9 flex-col items-center justify-center text-center shrink-0 hidden lg:flex">
            ...
            <h2 className="text-[16px] font-semibold text-[#2C2018] mb-2 leading-snug">
              Welcome to BookNest
            </h2>
            <p className="text-[12px] text-[#5C4530] leading-relaxed mb-5">
              Your personal reading sanctuary. Discover, read, and organize your
          ...
          <div className="lg:hidden absolute top-0 left-0 right-0 bg-[#DBBE9E] flex items-center gap-3 px-5 py-4">
            ...
            <span className="text-sm font-semibold text-[#2C2018]">
              BookNest
            </span>
          </div>
          ...
          <div className="bg-[#FDFAF7] flex-1 p-9 lg:p-9 px-5 flex flex-col justify-center">
            ...
            <h2 className="anim-item text-[20px] font-semibold text-[#2C2018] mb-1">
              Welcome Back
            </h2>
            <p className="anim-item text-[13px] text-[#9A8878] mb-6">
            ...
            >
              {apiError && (
                <div
                  className="anim-item p-4 mb-4 text-sm text-red-500 rounded-xl bg-[#fda5d5]/20"
                  role="alert"
                >
                  {apiError}
                </div>
              ...
              <div className="anim-item">
                <label className="block mb-1.5 text-xs font-medium text-[#444]">
                  Email Address
                </label>
                <input
                  type="email"
                ...
                {formik.errors.email && formik.touched.email && (
                  <div
                    className="mt-1 p-2 text-sm text-red-500 rounded-xl bg-[#fda5d5]/20"
                    role="alert"
                  >
                    {formik.errors.email}
                  </div>
              ...
              <div className="anim-item flex justify-between items-center mt-3 mb-5">
                <label className="flex items-center gap-2 text-xs text-[#666] cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-3.5 h-3.5 accent-[#D4A574]"
                  />
                  Remember me
                </label>
                <NavLink
              ...
              <div className="anim-item">
                {loading ? (
                  <button
                    type="submit"
                    className="text-white bg-[#D4A574] w-full box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-[14px] text-sm px-4 py-2.5 focus:outline-none cursor-pointer"
                  >
                  ...
                  <button
                    type="submit"
                    className="text-white bg-[#D4A574] w-full box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-[14px] text-sm px-4 py-2.5 focus:outline-none"
                  >
                    Login
                  </button>
                )}
